...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_path", type=str, default="/scratch/user/lihao/videos-instance", help="Path to dataset")
    parser.add_argument("--annot_path", type=str, default="/home/lihao/LSTM/data/daly1.1.0.pkl", help="Path to frames")
    parser.add_argument("--pose_path", type=str, default="/home/lihao/videos-pose", help="Path to poses")
    ...
    parser.add_argument("--latent_dim2", type=int, default=24, help="Dimensionality of the latent representation")
    ...
    def test_model(epoch):
        ...
        for batch_i, (Xf, Xp, y) in enumerate(test_dataloader):
            ...
            with torch.no_grad():
                ...
                model.lstm2.reset_hidden_state()
